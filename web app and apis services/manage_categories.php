...
?>
							...
							<div id="add-cat" class="widget-content">
                               <form class="form-horizontal row-border" id="validate-2" action="action/add_category.php"  method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-md-4"><input type="text" name="category_name" class="form-control required"></div>
									</div>
									<div class="form-group">
	...
	<div class="form-group">
										<label class="col-md-2 control-label" for="input17">Drink Category </label>
										<div class="col-md-4">
