							...
							<div class="widget-content no-padding">
								<table
									...
									<?php if($orderInfo->order_type == "serving"){?>
										...
										<tr>
											<td></td>
											<td><input type="button" value="Completed" class="btn btn-primary pull-right" onclick="UpdateOrder(<?=$orderInfo->order_id; ?>,'completed', 'manage_orders.php');" /><input type="button" value="Cancel" style="margin-right: 10px;" class="btn btn-primary pull-right" onclick="UpdateOrder(<?=$orderInfo->order_id; ?>,'cancel', 'manage_orders.php');" /><input type="button" value="Generate bill" style="margin-right: 10px;" class="btn btn-primary pull-right" /></td>
										</tr>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4>
									<i class="icon-reorder"></i> Confirm Orders List
								</h4>
								<div class="toolbar no-padding">
									<div class="btn-group">
										<span class="btn btn-xs widget-collapse"><i
							...
							<div class="widget-content">
								<table
									class="table table-striped table-bordered table-hover table-checkable datatable-confirm-order">
									<thead>
										<tr>
											<th>Order No.</th>
											<th>Order Type</th>
